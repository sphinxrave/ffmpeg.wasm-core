...
if [[ "$FFMPEG_ST" != "yes" ]]; then
  ...
  EXTRA_FLAGS=(
    ...
    -o wasm/packages/core/dist/ffprobe-core.js
  ...
  EXTRA_FLAGS=(
    -o wasm/packages/core-st/dist/ffprobe-core.js
...
FLAGS=(
  ...
  -lavdevice -lavfilter -lavformat -lavcodec -lswresample -lswscale -lavutil -lpostproc -lm -lharfbuzz 
  -lfribidi #-lass 
  -lx264 -lx265 -lvpx -lwavpack -lmp3lame -lfdk-aac -lvorbis -lvorbisenc -lvorbisfile -logg -ltheora -ltheoraenc -ltheoradec #-lz 
  -lfreetype -lopus -lwebp
